<template>
  <div>
    <Modal :title="L('EditOption')" :value="value" @on-ok="save" @on-visible-change="visibleChange" :mask-closable="false" :transfer="false">
...
@Component
export default class EditOptione extends AbpBase {
  ...
  visibleChange(value: boolean) {
    if (!value) {
      ...
      this.option = Util.extend(true, {}, this.$store.state.option.editOption);
    }
  }
  OptionRule = {
    name: [
