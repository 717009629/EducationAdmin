...
namespace EducationAdmin.Migrations
{
    ...
    partial class Upgraded_To_Abp_v222
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("EducationAdmin.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("EducationAdmin.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("EducationAdmin.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("EducationAdmin.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("EducationAdmin.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("EducationAdmin.Authorization.Users.User", "DeleterUser")
                        .WithMany()
