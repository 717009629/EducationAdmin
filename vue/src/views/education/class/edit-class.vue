<template>
  <div>
    <Modal :title="L('EditClass')" :value="value" @on-ok="save" @on-visible-change="visibleChange" :mask-closable="false" :transfer="false">
...
@Component
export default class EditClasse extends AbpBase {
